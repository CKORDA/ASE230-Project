...
<body>
    <div class="container mt-5">
        ...
        <form action="editvacation_process.php" method="post">
            ...
            <div id="vacationDetails" style="display: none;">
                <input type="hidden" name="originalVacation" id="originalVacation" value="">
                <div class="mb-3">
    ...
    <script>
        function loadVacationDetails(vacationName) {
            ...
            const originalVacationInput = document.getElementById('originalVacation');
            
            detailsDiv.style.display = vacationName ? 'block' : 'none';
            originalVacationInput.value = vacationName;
